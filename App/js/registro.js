...
document.getElementById("btn-cta").addEventListener("click", (e) => {
    ...
    var rep_contrasena = document.getElementById("repcontrasena").value
    if (nombre, apellido, correo, contrasena, rep_contrasena) {
            ...
            if (contrasena.length >= 8) {
                if (esCorreoElectronico(correo)) {
                    fetch(`http://localhost:3000/api/busqueda/${correo}`, {
                        ...
                        .then(data => {
                            if (data.length != 1) {
                                fetch(`http://localhost:3000/api/ingresar/${nombre}/${apellido}/${correo}/${contrasena}`, {
                                    method: "POST"
                                })
                                    .then(function () {
                                        plantilla.innerHTML = `Se ingreso el usuario`
                                        ...
                                        rep_contrasena = document.getElementById("repcontrasena").value = ""
                                    })
                                    .catch(error => {
                                        console.log(error)
                                    })
